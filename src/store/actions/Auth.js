...
export const logOut = () => {
 ...
 export const auth = (email , password , isSignup) => {
        return dispatch => {
            ...
            let url = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAzhakxQJ4q5t3MQ4WlZItUukJUqpi2AbY";
            if(!isSignup){
                url = "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAzhakxQJ4q5t3MQ4WlZItUukJUqpi2AbY"
            }
